...
Every significant bug encountered during development, in roughly chronological order. Each entry documents what broke, why, and how it was fixed. This is both a debugging reference and a design history — many of SCAN's architectural decisions were shaped by these bugs.
