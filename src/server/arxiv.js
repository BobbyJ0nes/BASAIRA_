// ═══════════════════════════════════════════════════════════
// SCAN Data Pipeline — arXiv Fetcher, Parser & Edge Computer
// ═══════════════════════════════════════════════════════════
//
...
//   4. MAP     — Assigns SCAN domains based on arXiv category codes
...
function fetchURL(url) {
  return new Promise((resolve, reject) => {
    https.get(url, { headers: { 'User-Agent': 'SCAN/1.0 (research-tool)' } }, (res) => {
...
// Map arXiv categories to SCAN domains
...
export async function fetchAllPapers() {
  console.log('\n╔══════════════════════════════════════╗');
  console.log('║   SCAN — Fetching papers from arXiv  ║');
  console.log('╚══════════════════════════════════════╝\n');
